...
IL_002b:
	{
		...
		NullCheck(L_7);
		bool L_9;
		L_9 = ((  bool (*) (Func_2_tE8C03B34A75321160F6D3EFCB01F9346EC7F21C7*, ControlItem_t25B2C46F52E78ADC5F54903F9E769364B02CD4AD, const RuntimeMethod*))il2cpp_codegen_get_method_pointer(il2cpp_rgctx_method(method->klass->rgctx_data, 9)))(L_7, L_8, il2cpp_rgctx_method(method->klass->rgctx_data, 9));
		if (!L_9)
		{
			goto IL_004e;
		}
...
IL_004e:
	{
		...
		bool L_12;
		L_12 = Enumerator_MoveNext_m8784F0F24421DA9476E0E4240A25D7760B24EF46(L_11, il2cpp_rgctx_method(method->klass->rgctx_data, 10));
		if (L_12)
		{
			goto IL_002b;
		}
...
IL_0041:
	{
		Func_2_t3E7E1CE662A1687DE5A95E07D6B0EFB6FD67A4C3* L_10 = __this->___selector_5;
		int32_t L_11 = V_0;
		NullCheck(L_10);
		InternedString_t8D62A48CB7D85AAE9CFCCCFB0A77AC2844905735 L_12;
